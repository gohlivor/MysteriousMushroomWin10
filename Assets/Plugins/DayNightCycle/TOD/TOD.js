var StartTime : float; 
var EndTime : float; 
var DayLength : float; //seconds

private var cycleStartTime : float;
...
function Update()
{
	...
	var time = Time.timeSinceLevelLoad - cycleStartTime;
